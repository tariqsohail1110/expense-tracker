import { CreateAdminRequestDto } from "../../modules/admin/dtos/create-admin-request.dto.js"

export const validateCreateAdminDto = (data) => {
    const errors = {}
    Object.keys(CreateAdminRequestDto).forEach(field => {
        if(!data[field]) {
